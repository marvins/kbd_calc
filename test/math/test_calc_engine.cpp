...
static void press(math::Calc_Engine& eng, std::initializer_list<core::Key_Code> keys) {
    for (core::Key_Code k : keys)
        eng.handle_key(k);
}
...
TEST(Calc_Engine_Decimal, Single_Decimal_Allowed) {
    ...
    press(eng, { core::Key_Code::DIGIT_3, core::Key_Code::DECIMAL, core::Key_Code::DIGIT_3 });
    EXPECT_EQ(eng.state().expression.eval_string(), "3.3");
}

TEST(Calc_Engine_Decimal, Second_Decimal_Ignored) {
    math::Calc_Engine eng;
    press(eng, { core::Key_Code::DIGIT_3, core::Key_Code::DECIMAL, core::Key_Code::DIGIT_3, core::Key_Code::DECIMAL });
    EXPECT_EQ(eng.state().expression.eval_string(), "3.3");
}
...
TEST(Calc_Engine_Decimal, Third_Decimal_Also_Ignored) {
    math::Calc_Engine eng;
    press(eng, { core::Key_Code::DIGIT_3, core::Key_Code::DECIMAL, core::Key_Code::DIGIT_3,
                 core::Key_Code::DECIMAL, core::Key_Code::DIGIT_3, core::Key_Code::DECIMAL });
...
TEST(Calc_Engine_Decimal, New_Token_After_Operator_Allows_Decimal) {
    ...
    press(eng, { core::Key_Code::DIGIT_3, core::Key_Code::DECIMAL, core::Key_Code::DIGIT_3,
                 core::Key_Code::ADD,
                 core::Key_Code::DIGIT_1, core::Key_Code::DECIMAL, core::Key_Code::DIGIT_1 });
...
TEST(Calc_Engine_Evaluate, Two_Plus_Three) {
    math::Calc_Engine eng;
    press(eng, { core::Key_Code::DIGIT_2, core::Key_Code::ADD, core::Key_Code::DIGIT_3,
                 core::Key_Code::EQUALS });
    EXPECT_EQ(eng.state().display_value, "5");
}

TEST(Calc_Engine_Evaluate, Pi_Stays_Symbolic) {
    math::Calc_Engine eng;
    press(eng, { core::Key_Code::PI, core::Key_Code::EQUALS });
    EXPECT_EQ(eng.state().display_value, "pi");
}

TEST(Calc_Engine_Evaluate, Two_Times_Pi_Stays_Symbolic) {
    math::Calc_Engine eng;
    press(eng, { core::Key_Code::DIGIT_2, core::Key_Code::MULTIPLY, core::Key_Code::PI,
                 core::Key_Code::EQUALS });
...
TEST(Calc_Engine_Evaluate, Sqrt_Of_Four_Folds) {
    math::Calc_Engine eng;
    press(eng, { core::Key_Code::SQRT, core::Key_Code::DIGIT_4, core::Key_Code::PAREN_CLOSE,
                 core::Key_Code::EQUALS });
...
TEST(Calc_Engine_Evaluate, Sqrt_Of_Pi_Stays_Symbolic) {
    math::Calc_Engine eng;
    press(eng, { core::Key_Code::SQRT, core::Key_Code::PI, core::Key_Code::PAREN_CLOSE,
                 core::Key_Code::EQUALS });
...
TEST(Calc_Engine_Approx, Wraps_Expression_And_Evaluates) {
    math::Calc_Engine eng;
    press(eng, { core::Key_Code::APPROX,
                 core::Key_Code::PI,
                 core::Key_Code::PAREN_CLOSE,
                 core::Key_Code::EQUALS });
...
TEST(Calc_Engine_Approx, Token_Is_Atomic_Backspace) {
    ...
    eng.handle_key(core::Key_Code::BACKSPACE);
