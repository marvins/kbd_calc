...
#ifdef TARGET_RP2350
    #define LV_MEM_SIZE (128 * 1024U)     /*128 KB for RP2350 (520 KB total RAM)*/
#else
    #define LV_MEM_SIZE (4 * 1024 * 1024U) /*4 MB for SDL simulator*/
#endif
 ...
 */
#define LV_FONT_CUSTOM_INCLUDE "../../../../lv_font_custom.h"
