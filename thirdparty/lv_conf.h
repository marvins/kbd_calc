...
#define LV_STDARG_INCLUDE       <stdarg.h>
    ...
    #ifdef TARGET_RP2350
        #define LV_MEM_SIZE (128 * 1024U)     /*[bytes] 128 KB for RP2350 (520 KB total RAM)*/
    #else
        #define LV_MEM_SIZE (4 * 1024 * 1024U) /*[bytes] 4 MB for SDL simulator*/
    #endif
...
#define LV_FONT_CUSTOM_DECLARE LV_FONT_DECLARE(lv_font_superscript_regular) LV_FONT_DECLARE(lv_font_superscript_bold)
...
#define LV_USE_SDL              1
    ...
    #define LV_SDL_BUF_COUNT        1    /*1 or 2*/
        ...
        #define LV_SDL_ACCELERATED      0    /*No hardware acceleration in WASM*/
    #else
